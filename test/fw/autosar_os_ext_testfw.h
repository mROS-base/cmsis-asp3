...
extern void autosar_os_ext_testfw_failed_callback(const char *testname, int testno);
...
extern void autosar_os_ext_testfw_clr_cyclic_handler_func(void);
extern void *autosar_os_ext_testfw_get_cyclic_handler_argp(void);
